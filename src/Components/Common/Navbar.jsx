...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar bg-gradient-to-r from-[#A45CFF] to-[#7ED8FF] text-white shadow-lg px-10">
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <Link
                                ...
                                className="btn bg-gradient-to-r from-[#A45CFF] to-[#7ED8FF] text-white px-6 transition-all font-medium"
                            >
                                Register
                            </Link>
                        </>
