...
const NotFound = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FAF8F0] to-white flex items-center">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-r from-[#A45CFF] to-[#7ED8FF] w-24 h-24 rounded-full flex items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/"
              className="bg-gradient-to-r from-[#6A0DAD] to-[#9F62F2] text-white py-3 px-8 rounded-full font-semibold hover:opacity-90 transition-opacity shadow-lg flex items-center justify-center"
            >
            ...
            <Link
              to="/availableclubs"
              className="bg-gradient-to-r from-[#A45CFF] to-[#7ED8FF] text-white py-3 px-8 rounded-full font-semibold hover:opacity-90 transition-opacity shadow-lg flex items-center justify-center"
            >
